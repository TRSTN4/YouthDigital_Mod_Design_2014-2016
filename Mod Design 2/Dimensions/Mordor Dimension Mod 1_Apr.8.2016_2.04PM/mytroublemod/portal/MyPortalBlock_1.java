...
import mytroublemod.tsconfig.troubleapi.dimension.ModTeleporter;
...
public class MyPortalBlock_1 extends ModPortalBlock {
   ...
   public void onEntityCollidedWithBlock(World par1World, int par2, int par3,
        ...
        if ((par5Entity.ridingEntity == null)
            ...
            if (thePlayer.timeUntilPortal > 0) {
            ...
            } else if (thePlayer.dimension != TroubleMain.MyDimensionID_1) {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer
                        .getConfigurationManager()
                        .transferPlayerToDimension(
                                thePlayer,
                                TroubleMain.MyDimensionID_1,
                                new ModTeleporter(
                                        thePlayer.mcServer
                                                .worldServerForDimension(TroubleMain.MyDimensionID_1), TroubleMain.MyFrameBlock_1, TroubleMain.MyPortalBlock_1, TroubleMain.MyPortal_1));
            } else {
                thePlayer.timeUntilPortal = 10;
                thePlayer.mcServer.getConfigurationManager()
                        .transferPlayerToDimension(
                                thePlayer,
                                0,
                                new ModTeleporter(thePlayer.mcServer.worldServerForDimension(0), TroubleMain.MyFrameBlock_1, TroubleMain.MyPortalBlock_1, TroubleMain.MyPortal_1));
            }
        }
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3,
        ...
        if (par5Random.nextInt(80) == 0) {
            par1World.playSound((double) par2 + 0.5D, (double) par3 + 0.5D,
                    (double) par4 + 0.5D, "random.eat", 0.5F,
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            par1World.spawnParticle("snowballpoof", d0, d1, d2, d3, d4, d5);
        }
    }
